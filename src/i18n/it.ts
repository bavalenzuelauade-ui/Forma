...
const it: Dictionary = {
  ...
  about: {
    ...
    team: 'Il team',
    teamText: 'Siamo un team giovane di Bariloche specializzato in branding e tecnologia che ha deciso di costruire qualcosa di proprio. Ci muove la qualita, le relazioni a lungo termine e la crescita reciproca con ogni cliente.',
